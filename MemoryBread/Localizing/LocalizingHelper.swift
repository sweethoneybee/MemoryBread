//
//  LocalizingHelper.swift
//  MemoryBread
//
//  Created by 정성훈 on 2021/11/24.
//

import Foundation

struct LocalizingHelper {
    static let appTitle = "app_title".localized
    static let cancel = "cancel".localized
    static let done = "done".localized
    static let editContent = "edit_content".localized
    
    static let changingTheTitle = "changing_the_title".localized
    ...
    static let downloadFailed = "download_failed".localized
