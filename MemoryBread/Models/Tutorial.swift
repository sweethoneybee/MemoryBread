...
struct Tutorial {
    ...
    var infos = [
        Info(title: "3. 암기빵 생성 및 제목, 내용 수정 방법",
             content: "암기빵 목록에서 오른쪽 위의 '+' 버튼을 누르면 새로운 암기빵을 생성할 수 있습니다. 제목을 수정하고 싶다면 제목을 터치하여 수정할 수 있습니다. 내용을 수정하고 싶다면 오른쪽 위의 메모지 버튼을 터치하여 수정합니다. 내용이 수정되면 기존의 색필터 정보는 모두 사라지니 주의해주세요.",
             filterIndexes: [
                (0, 2),
                (1, 2),
                (2, 2),
